package com.example.PAM4.database;
...
import com.example.PAM4.database.dao.UserDao;
...
public abstract class AppDatabase extends RoomDatabase {
    ...
    private void updateDatabseCreated(final Context context){
        ...
        if (sInstance == null){
            synchronized (AppDatabase.class){
                if (sInstance == null){
                    ...
                    sInstance.updateDatabseCreated(context.getApplicationContext());
                }
            }
        }
        return sInstance;
